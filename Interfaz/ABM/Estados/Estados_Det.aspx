<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Estados_Det.aspx.cs" Inherits="Interfaz.ABM.Estados.Estados_Det" %>
     ...
     <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Modificar Estado</strong></li>
            </ol>
        </div>
    </div>
