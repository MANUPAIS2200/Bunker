<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Permisos_New.aspx.cs" Inherits="Interfaz.ABM.Permisos.Permisos_New" %>
     ...
     <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Agregar Permiso</strong></li>
            </ol>
        </div>
    </div>
