<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Paises_Det.aspx.cs" Inherits="Interfaz.ABM.Paises.Paises_Det" %>
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Modificar Pais</strong></li>
            </ol>
        </div>
    </div>
