<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Etapas_New.aspx.cs" Inherits="Interfaz.ABM.Etapas.Etapas_New" %>
       ...
       <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Agregar Etapa</strong></li>
            </ol>
        </div>
    </div>
